...
-- Give the final feasibility report in a new MD file: cluster-upgrade-feasibility-and-risks.md
-- Then read cluster-upgrade-execution-plan.md (the plan template in this repo) and use it to generate a platform-specific execution plan in a new MD file: plan.md
